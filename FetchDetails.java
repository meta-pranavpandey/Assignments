...
public class FetchDetails {
	...
	public static void main(String args[]) {
		...
		DAOManager libraryInfo = new DAOManager();
		...
		List<Titles> titles = libraryInfo.getBookTitle(author);
		...
		for (int index = 0; index < titles.size(); index++) {
			...
			System.out.println(title.getTitle_Id() + " " + title.getTitle_Name());
		}

		// (Assignment 2)Getting information regarding wheher book is is issued
		// or not
		System.out
		...
		// (Assignment 3)Deleting the books which were not issued for more than
		// 1 year
